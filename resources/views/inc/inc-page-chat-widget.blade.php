          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/03.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/20.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline away">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/05.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline offline">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/04.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/09.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/12.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline away">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/10.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/07.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline offline">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/02.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/08.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
        ...
        <div class="user-status">
          ...
          <div class="user-status-avatar">
            ...
            <div class="user-avatar small no-outline online">
              ...
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="{{ asset('assets/vikinger/img/avatar/14.jpg') }}"></div>
                <!-- /HEXAGON -->
              </div>
              <!-- /USER AVATAR CONTENT -->
      ...
      <div class="chat-widget-speaker left">
        ...
        <div class="chat-widget-speaker-avatar">
          ...
          <div class="user-avatar tiny no-border">
            ...
            <div class="user-avatar-content">
              <!-- HEXAGON -->
              <div class="hexagon-image-24-26" data-src="{{ asset('assets/vikinger/img/avatar/03.jpg') }}"></div>
              <!-- /HEXAGON -->
            </div>
            <!-- /USER AVATAR CONTENT -->
          </div>
