            ...
            <tr>
                <td>
                    ...
                    <div style="background: white !important;max-width: 500px; margin:0 auto; padding: 30px;">
                        ...
                        <p style="color: #000">
                            We've received and is now proccessing your lesson application. Please wait for the confirmation of your lession with
                            <a style="color: #85388b;
                                text-decoration: none;
                                font-weight: 900;
                                font-size: 15px;" href="{{ url('studio/' . $instructor_slug) }}"
                            >
                                {{ $instructor_name }}
                            </a>.
                        </p>
                        <p style="color: #000">This usually takes 1 to 2 days. Once approved, we will send you a notification with the complete details of your session.</p>
                        ...
                        >
                            ...
                            >
                                <p class="information-line-title" style="color: #000">Instructor</p>
