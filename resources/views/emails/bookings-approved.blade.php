            ...
            <tr>
                <td>
                    ...
                    <div style="background: white !important;max-width: 500px; margin:0 auto; padding: 30px;">
                        ...
                        <p style="color: #000">Your booking was successfully approved. Check below for more details.</p>
                        ...
                        >    <br>
                            ...
                            <center><a href="{{$meeting_link}}" class="details-text" style="text-decoration: none;background: #85388b;padding: 20px 50px;border-radius: 10px;color: #fff !important;margin-top: 20px;margin-bottom: 20px;text-align: center;">Start Call</a></center>
                            <br><br>         
                        </div>
                        <p>Good luck!</p>
                    </div>
