            ...
            <tr>
                <td>
                    ...
                    <div style="background: white !important;max-width: 500px; margin:0 auto; padding: 30px;">
                        <p style="color: #000 !important">Hi {{ $receiver }}, eeee</p>

                        <p style="color: #000 !important; margin-bottom: 0">
                            Thank you for signing up for a free student Harmelo account.
                        </p>
                        <p style="color: #000 !important; margin-top: 0">
                            In order to login, you'll need to verify your e-mail address using the button below.
                        </p>
                        <a class="verify-btn" href="{{ $verification_link }}">
